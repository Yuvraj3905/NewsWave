    ...
    <div className="max-w-3xl mx-auto px-4 py-10">
      <div className="bg-white rounded-lg border border-navy-100 shadow-card p-6 sm:p-8">
        ...
        <div className="space-y-5 text-sm text-navy-700 leading-relaxed">
          <section>
            <h2 className="font-bold text-navy-900 text-base mb-1">Who We Are</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold text-navy-900 text-base mb-1">What We Cover</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold text-navy-900 text-base mb-1">Editorial Standards</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold text-navy-900 text-base mb-1">Get in Touch</h2>
            <p>
