    ...
    <div className="max-w-3xl mx-auto px-4 py-10">
      <div className="bg-white rounded-lg border border-navy-100 shadow-card p-6 sm:p-8">
        ...
        <div className="space-y-5 text-sm text-navy-700 leading-relaxed">
          <section>
            <h2 className="font-bold text-navy-900 text-base mb-2">Why NewsWave</h2>
          ...
          <section>
            <h2 className="font-bold text-navy-900 text-base mb-2">Ad Inventory</h2>
            <div className="grid sm:grid-cols-2 gap-3">
              {[
                ...
                <div
                  key={item.name}
                  className="border border-navy-100 rounded p-3 bg-surface-50"
                >
                  <div className="font-semibold text-navy-900">{item.name}</div>
                  <div className="text-xs text-navy-500 mt-0.5">{item.spec}</div>
                </div>
              ))}
            </div>
          </section>
          ...
          <section>
            <h2 className="font-bold text-navy-900 text-base mb-2">Get in Touch</h2>
            <p>
